...
Event.create!(
  ...
  title: "空体丨周五晚独立音乐分享会",
  description: "如果要把世界填充满的话，用音乐和食物，就够了。鼓手，吉他手，键盘手，民谣歌手，原创音乐人……来这里，听他们的梦想与坚持。",
  ...
  logo: MiniMagick::Image.open("#{Rails.root}/app/assets/images/music/102.jpg")
)
...
Event.create!(
  ...
  description: "【只要2小时】从零基础到自弹自唱—达成， 认识更多有趣的朋友， 感受尤克里里的独特魅力， 收获更多不一样的欢乐体验。",
...
Event.create!(
  ...
  user_id: users.sample.id,
  title: "重逢箭扣长城，东线穿越",
  description: "活动线路：渔场—箭扣—小布达拉—正北楼—牛角边—慕田峪—营北沟；
                活动强度：全程8KM左右，上升下降均约900米，
...
Event.create!(
  ...
  user_id: users.sample.id,
  title: "泡面食堂大侠召集令",
  description: "泡面食堂大侠召集令！邀请你来亲尝为你收刮来的世界级的泡面！
                让你来评价一下，哪一款泡面成为你的freestyel！
                你可以是很爱吃泡面的吃货
                游侠客帮你架起与泡面的友谊之桥
                你也可以是很爱凑热闹的XX群众
                游侠客【泡面食堂】最不缺的就是热闹！",
...
Event.create!(
  ...
  description: "赛事介绍：1、捏泡泡大赛：捏泡泡才能满足的叫手感； 2、给陌生人打电话：谁聊最长谁赢啊，3、吐豆子大赛：听说射程好的都在这……关于这样的扯淡游戏，我们还准备了十几个，想不想来嘛？",
...
Event.create!(
  ...
  status: ["preparing","processing"].sample,
  logo: MiniMagick::Image.open("#{Rails.root}/app/assets/images/friends/201.jpg")
)
...
Event.create!(
  ...
  user_id: users.sample.id,
  title: "光阴读书会 | 朗读场",
  description: "朗读，是人与生俱来的能力。无论乡关何处，情相通。
                朗读，是古已有之的音乐。快慢行柔、抑扬顿挫，皆成乐章。
                关闭其他感官，耳朵借我，感受声波经空气带来的按摩。
                放下一切评判，把心打开，体会平凡文字的撩拨。
...
Event.create!(
  ...
  user_id: users.sample.id,
  title: "周末拒绝宅，一起狼人杀吧",
  description: "一局狼人杀会让你爱上桌游, 也会使你深刻体会快乐真的会让时间变得匆匆,加入我们，一起玩耍吧",
  address: "北京海淀区避风塘",
  sponsor: "殽赦",
  limited_num: 15,
